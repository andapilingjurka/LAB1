...
const Home = ()=>{
    return(
         <Fragment>
              <Header/>
              <section className='numbers'style={{backgroundColor:"#024585e5"}}>
              ...
              <section className='pride'>
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-md-6' >
                                    <h2 style={{color:"green"}}>Features of our site</h2>
                                    ...
                                    <button style={{backgroundColor:"green"}}><a href='#'>See more</a></button>
                            </div>
              ...
              <section className='ingredients'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-6'>
                            <h2 style={{color:"green"}}>The benefits of our application</h2>
